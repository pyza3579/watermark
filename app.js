...
const addTextWatermarkToImage = async function(inputFile, outputFile, text) {
  try { 
    ...
    image.print(font, 10, 10, textData, image.getWidth(), image.getWidth());
    await image.quality(100).writeAsync(outputFile);
  
    console.log('It is working! You added a text to your image')
    startApp();
  }
  catch(error){
    console.log(error);
...
const addImageWatermarkToImage = async function(inputFile, outputFile, watermarkFile) {
  try{
    ...
    console.log('It is working! You added a logo to your image')
    startApp();
  }
  catch(error){
    console.log(error);
